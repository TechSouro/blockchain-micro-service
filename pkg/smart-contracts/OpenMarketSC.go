...
// FilterPublicOrderCreated is a free log retrieval operation binding the contract event 0x6846e129440de8eadb5860e065ac3b1f9d2108177bae63a5b76ec46c409ecfa0.
//
// Solidity: event publicOrderCreated(uint256 indexed _tokenId, uint256 indexed _units, uint256 _price)
func (_OpenMarket *OpenMarketFilterer) FilterPublicOrderCreated(opts *bind.FilterOpts, _tokenId []*big.Int, _units []*big.Int) (*OpenMarketPublicOrderCreatedIterator, error) {
	...
	logs, sub, err := _OpenMarket.contract.FilterLogs(opts, "publicOrderCreated", _tokenIdRule, _unitsRule)
	if err != nil {
		return nil, err
	}
...
// WatchPublicOrderCreated is a free log subscription operation binding the contract event 0x6846e129440de8eadb5860e065ac3b1f9d2108177bae63a5b76ec46c409ecfa0.
//
// Solidity: event publicOrderCreated(uint256 indexed _tokenId, uint256 indexed _units, uint256 _price)
func (_OpenMarket *OpenMarketFilterer) WatchPublicOrderCreated(opts *bind.WatchOpts, sink chan<- *OpenMarketPublicOrderCreated, _tokenId []*big.Int, _units []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _OpenMarket.contract.WatchLogs(opts, "publicOrderCreated", _tokenIdRule, _unitsRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParsePublicOrderCreated is a log parse operation binding the contract event 0x6846e129440de8eadb5860e065ac3b1f9d2108177bae63a5b76ec46c409ecfa0.
//
// Solidity: event publicOrderCreated(uint256 indexed _tokenId, uint256 indexed _units, uint256 _price)
