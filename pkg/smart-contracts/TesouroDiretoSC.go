...
// FilterTreasuryCreated is a free log retrieval operation binding the contract event 0xe9c0a77d0c08cee56e6e88ce7ffdcd59129ee363214ae939f64009951413a0d2.
//
// Solidity: event treasuryCreated(uint256 indexed _totalValue, uint256 indexed _apy, uint256 indexed _duration, uint8 arg3)
func (_TesouroDireto *TesouroDiretoFilterer) FilterTreasuryCreated(opts *bind.FilterOpts, _totalValue []*big.Int, _apy []*big.Int, _duration []*big.Int) (*TesouroDiretoTreasuryCreatedIterator, error) {
	...
	var _durationRule []interface{}
	for _, _durationItem := range _duration {
		_durationRule = append(_durationRule, _durationItem)
	}

	logs, sub, err := _TesouroDireto.contract.FilterLogs(opts, "treasuryCreated", _totalValueRule, _apyRule, _durationRule)
	if err != nil {
		return nil, err
	}
...
// WatchTreasuryCreated is a free log subscription operation binding the contract event 0xe9c0a77d0c08cee56e6e88ce7ffdcd59129ee363214ae939f64009951413a0d2.
//
// Solidity: event treasuryCreated(uint256 indexed _totalValue, uint256 indexed _apy, uint256 indexed _duration, uint8 arg3)
func (_TesouroDireto *TesouroDiretoFilterer) WatchTreasuryCreated(opts *bind.WatchOpts, sink chan<- *TesouroDiretoTreasuryCreated, _totalValue []*big.Int, _apy []*big.Int, _duration []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _TesouroDireto.contract.WatchLogs(opts, "treasuryCreated", _totalValueRule, _apyRule, _durationRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseTreasuryCreated is a log parse operation binding the contract event 0xe9c0a77d0c08cee56e6e88ce7ffdcd59129ee363214ae939f64009951413a0d2.
//
// Solidity: event treasuryCreated(uint256 indexed _totalValue, uint256 indexed _apy, uint256 indexed _duration, uint8 arg3)
