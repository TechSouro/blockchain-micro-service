...
func InitEventSystem() {
	...
	// /* Prod */
	// The commented code block is defining the values for various Ethereum contract addresses and the
	// client URL for connecting to the Ethereum network. These addresses and URL are used to interact
	...
	// Aplica o middleware CORS às suas rotas
	handler := c.Handler(r)
